...
Not registered here (intentionally):
  - recovery_workflow
  - charging_workflow
  These are user-implemented stubs; see their files.
...
WORKFLOW_REGISTRY: Dict[str, GraphFactory] = {
  ...
  # recovery_workflow  — user-implemented; do not register until ready
  # charging_workflow  — user-implemented; do not register until ready
}
